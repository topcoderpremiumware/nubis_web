...
function TerminalEditPopup(props) {
  ...
  var onChange = function onChange(e) {
    ...
    if (e.target.name === 'name') setTerminal(function (prev) {
      return _objectSpread(_objectSpread({}, prev), {}, {
        name: e.target.value
      });
    });
    if (e.target.name === 'provider') setTerminal(function (prev) {
      return _objectSpread(_objectSpread({}, prev), {}, {
...
function Terminals() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    _eventBus__WEBPACK_IMPORTED_MODULE_1__["default"].on("placeChanged", placeChanged);
    return function () {
      _eventBus__WEBPACK_IMPORTED_MODULE_1__["default"].remove("placeChanged", placeChanged);
    };
  }, []);
